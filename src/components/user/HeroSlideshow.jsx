...
const Slide = forwardRef((props, ref) => {
  ...
  return (
    ...
    >
      {src ? (
        <img className=" object-cover w-full" src={src} alt="" />
      ) : null}
      {title ? (
        <div className="absolute mx-10 inset-0 flex flex-col justify-end py-3 bg-gradient-to-t from-white dark:from-primary">
